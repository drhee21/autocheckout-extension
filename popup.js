document.addEventListener('DOMContentLoaded', function() {
    ...
    // Populate country dropdown with ISO 3166-1 alpha-2 codes
    const countries = [
    ...
    // Populate US states dropdown with two-letter codes
    const usStates = [
    ...
    usStates.forEach(({ code, name }) => {
        const option = document.createElement('option');
        option.value = code;
        option.textContent = code; // show compact two-letter code
        stateSelect.appendChild(option);
    });

    // Load saved data
    chrome.storage.local.get([
        'firstName', 'lastName', 'address1', 'address2', 'city', 'state', 'country', 'postal', 'email', 'phone'
    ], function(data) {
